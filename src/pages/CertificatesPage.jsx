...
function CertificatesPage() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Adicionar um novo Certificado</CardTitle>
          <CardDescription>Crie um novo certificado para aplicar aos seus Distributions</CardDescription>
        </CardHeader>
        <CardContent>
          <div>
            <Label htmlFor="dist-name" className='mb-1'>Endereço do Certificado</Label>
            <div className="flex items-center justify-center gap-5">
              <div className="w-4/5">
                <Input
                  id="dist-name"
                  placeholder="*.clarocdn.com.br"
      ...
      <Card>
        <CardHeader>
          <CardTitle>Certificados já criados</CardTitle>
          <CardDescription>Lista de todos os certificados cadastrados:</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
