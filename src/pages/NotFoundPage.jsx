...
function NotFoundPage() {
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="container max-w-lg mx-auto p-8 text-center bg-white dark:bg-gray-800 shadow-2xl rounded-lg">
        <img src={Logo} alt="Logo Claro" className='relative w-14 h-14 left-1/2 -translate-x-1/2 top-3 mb-5' />
        
        {/* Usando um ícone do Lucide para manter a consistência do seu projeto */}
        <Frown className="w-32 h-32 mx-auto text-gray-400 dark:text-gray-500" strokeWidth={1} />
        ...
        */}
        <Link 
           to="/distributions" 
           className="inline-block px-6 py-3 mt-8 font-semibold !text-white bg-red-600 rounded-lg shadow-md hover:bg-red-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:bg-red-500 dark:hover:bg-red-600">
